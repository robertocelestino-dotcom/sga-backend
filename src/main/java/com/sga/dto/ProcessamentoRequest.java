...
public class ProcessamentoRequest {
	...
	public boolean isValid() {
		return (associadosIds != null && !associadosIds.isEmpty()) && mes != null && ano != null;
	}
	...
	public String toString() {
		return "ProcessamentoRequest{" + "quantidadeAssociados=" + getQuantidadeAssociados() + ", mes=" + mes + ", ano="
				+ ano + ", extemporaneo=" + extemporaneo + ", integrarRm=" + integrarRm + ", gerarNotas=" + gerarNotas
				+ ", simular=" + simular + ", reguaId=" + reguaId + ", dataEmissao=" + dataEmissao + ", dataVencimento="
				+ dataVencimento + '}';
	}
}